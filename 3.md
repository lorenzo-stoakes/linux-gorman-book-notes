...
* `pmd_alloc(mm, pgd, address)` - Given a process's `mm`, a
  ...
  [pmd_offset()][pmd_offset/3lvl] on i386 - i.e. since all PMDs are either folded
...
[swapper_pg_dir]:http://fxr.watson.org/fxr/source/include/asm-i386/pgtable.h?v=linux-2.4.22#L24
